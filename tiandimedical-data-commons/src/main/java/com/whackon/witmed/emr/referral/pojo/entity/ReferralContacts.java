...
/**
 * <b>天地医疗信息平台 - 电子病历功能 - 转诊（院）联系人实体信息<b/>
 * @author yan
 * @date 2022/9/12
 */
@Data
@TableName("sys_referral_contacts")
public class ReferralContacts extends BaseEntity {
	private static final long serialVersionUID = -3944642426765160434L;
