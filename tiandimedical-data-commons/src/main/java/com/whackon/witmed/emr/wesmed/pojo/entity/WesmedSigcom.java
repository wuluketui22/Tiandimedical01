...
/**
 * <b>天地医疗信息平台 - 电子病历功能 - 西医处方通信实体信息<b/>
 * @author yan
 * @date 2022/9/12
 */
@Data
@TableName("sys_wesmed_sigcom")
public class WesmedSigcom extends BaseEntity {
	private static final long serialVersionUID = 4799479821307248382L;
